...
sum_frames = 10
c["Autosave Movie Sum Count"] = sum_frames  # The total number of frames summed `c.start_acquisition`.

c["Frames Per Second"] = 200  # The number of frames per second to acquire
c["Frame Count"] = 40  # The number of frames to acquire

print(f"Summed Frames Per Second: {c['Frames Per Second']/c['Autosave Movie Sum Count']}\n"
